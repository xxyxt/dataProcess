...
inputFilePath='C:\\Users\\tx\Desktop\\20191111\\data\\OriginalData2\\.xlsx';
outputFilePath='D:\\workBench\\matlabworkbench\\data20\\';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [T_caculate,V1]=ReadFile()
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['J' num2str(starPoint) ':' 'J' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['S' num2str(starPoint) ':' 'S' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['P' num2str(starPoint) ':' 'P' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['M' num2str(starPoint) ':' 'M' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AB' num2str(starPoint) ':' 'AB' num2str(endPoint)]);
    % V1=V1*1.3;
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AE' num2str(starPoint) ':' 'AE' num2str(endPoint)]);
    % V1=V1*1.6;
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AH' num2str(starPoint) ':' 'AH' num2str(endPoint)]);
    % V1=V1*2;
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AK' num2str(starPoint) ':' 'AK' num2str(endPoint)]);
    % V1=V1*3;
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AN' num2str(starPoint) ':' 'AN' num2str(endPoint)]);
    % V1=V1*4;
    ...
    % V1=xlsread(inputFilePath,'Sheet1',['AQ' num2str(starPoint) ':' 'AQ' num2str(endPoint)]);
    % V1=V1*6;
