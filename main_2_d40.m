...
function OriginPlot()
    ...
    fdir= 'D:\\workBench\\OriginWorkbench\\figure40';
...
function [T_caculate,V1]=ReadFile()
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['J' num2str(starPoint) ':' 'J' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['S' num2str(starPoint) ':' 'S' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['P' num2str(starPoint) ':' 'P' num2str(endPoint)]);
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['AH' num2str(starPoint) ':' 'AH' num2str(endPoint)]);
    % V1=V1*2;
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['AK' num2str(starPoint) ':' 'AK' num2str(endPoint)]);
    % V1=V1*3;
    ...
    % V1=xlsread(inputFilePath,'Sheet3',['AN' num2str(starPoint) ':' 'AN' num2str(endPoint)]);
    % V1=V1*4;
    ...
    V1=xlsread(inputFilePath,'Sheet3',['AQ' num2str(starPoint) ':' 'AQ' num2str(endPoint)]);
    V1=V1*6;
end
