...
clc;
clear;
global hp rp R d33 varepsilon33 S0 P v d s a alpha w1 w2 V_plot T_caculate mdata T starPoint sigma_caculate sigma_model endPoint T_model startTime endTime fileName inputFilePath outputFilePath template
...
outputFilePath='D:\\workBench\\matlabworkbench\\data40\\';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [T_caculate,V_caculate,V_plot]=ReadFile()
    ...
    % d33=650*10^-12;  
    % fileName='2-2并2M滤波15';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['I' num2str(starPoint) ':' 'I' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['J' num2str(starPoint) ':' 'J' num2str(endPoint)]);
    % V_caculate=V_plot;
    ...
    % d33=650*10^-12;  
    % fileName='2-2并4M未滤波';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['R' num2str(starPoint) ':' 'R' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['S' num2str(starPoint) ':' 'S' num2str(endPoint)]);
    % V_caculate=V_plot;
    ...
    % d33=650*10^-12;  
    % fileName='2-2并6M未滤波';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['O' num2str(starPoint) ':' 'O' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['P' num2str(starPoint) ':' 'P' num2str(endPoint)]);
    % V_caculate=V_plot;
    ...
    % d33=650*10^-12;  
    % fileName='2-2串10M未滤波';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['AG' num2str(starPoint) ':' 'AG' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['AH' num2str(starPoint) ':' 'AH' num2str(endPoint)]);
    % V_caculate=V_plot*2;
    ...
    % d33=600*10^-12;  
    % fileName='2-2串20M未滤波';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['AJ' num2str(starPoint) ':' 'AJ' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['AK' num2str(starPoint) ':' 'AK' num2str(endPoint)]);
    % V_caculate=V_plot*3;
    ...
    % d33=650*10^-12;  
    % fileName='2-2串30M未滤波';
	% T_caculate=xlsread(inputFilePath,'Sheet3',['AM' num2str(starPoint) ':' 'AM' num2str(endPoint)]);
    % V_plot=xlsread(inputFilePath,'Sheet3',['AN' num2str(starPoint) ':' 'AN' num2str(endPoint)]);
    % V_caculate=V_plot*4;
    ...
    d33=600*10^-12;  
    fileName='2-2串50M未滤波';
	T_caculate=xlsread(inputFilePath,'Sheet3',['AP' num2str(starPoint) ':' 'AP' num2str(endPoint)]);
    V_plot=xlsread(inputFilePath,'Sheet3',['AQ' num2str(starPoint) ':' 'AQ' num2str(endPoint)]);
    V_caculate=V_plot*6;
end
